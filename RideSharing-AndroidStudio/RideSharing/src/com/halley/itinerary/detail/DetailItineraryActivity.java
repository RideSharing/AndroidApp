package com.halley.itinerary.detail;
...
import com.halley.itinerary.notification.ScheduleClient;
import com.halley.registerandlogin.R;
import com.halley.itinerary.tracking.TrackingActivity;

import cn.pedant.SweetAlert.SweetAlertDialog;

public class DetailItineraryActivity extends ActionBarActivity implements
		OnDataPass,View.OnClickListener {
	private static final String TAG = DetailItineraryActivity.class
			.getSimpleName();
...
//        }
	...
	private String downloadUrl(String strUrl) throws IOException {
		...
		try {
			...
			Log.d("Exception while d url", e.toString());
		} finally {
			iStream.close();
