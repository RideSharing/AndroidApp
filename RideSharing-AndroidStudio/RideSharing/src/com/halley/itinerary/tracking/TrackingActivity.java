package com.halley.itinerary.tracking;
...
import com.halley.profile.ratingandcomment.RatingandCommentDialogFragment;
...
public class TrackingActivity extends ActionBarActivity implements
	...
	private Marker marker_customer;
	...
	public void test(String latlng) {
        if ("Start itinerary".equals(latlng)) {
            ...
            focusMap(marker_customer, marker_driver);
        }
	}
	...
	public void endItinerary(final String itinerary_id) {
		...
		StringRequest strReq = new StringRequest(Request.Method.PUT,
				AppConfig.URL_DRIVER_END_ITINERARY + "/" + itinerary_id+"?lang="+ Locale.getDefault().getLanguage(),
	...
	public void onLocationChanged(Location location) {
        ...
        if (marker_customer != null) {
            marker_customer.remove();
        }
        marker_customer = addMarkeronMaps(mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude(), "customer", "marker_customer",
				R.drawable.ic_marker_driver);
		...
		String latlng = String.format("%.6f", location.getLatitude()) + "#"
				+ String.format("%.6f", location.getLongitude()) + "#" +(role.equals(DRIVER_ROLE)?"d":"c");
