...
public class ListManageItineraryAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		start_address.setText(R.string.start_addess + m.getStart_address());
		end_address.setText(R.string.end_addess + m.getEnd_address());
		duration.setText(R.string.duration+ transferDuration(m.getDuration()));
		cost.setText(R.string.cost + transferCost(m.getCost()));
		leave_date.setText(R.string.leave_date + m.getLeave_date());
		return convertView;
	}
